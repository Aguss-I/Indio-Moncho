...
export default class Nivel3 extends Phaser.Scene {
    ...
    create() {
      ...
      this.objetivoText= this.add.text(500,15,"objetivo: 15 estrellas",{
        fontSize: "15px",fill: "#FFFFFF"}
      );
      this.nivelText=this.add.text(325,15,"Nivel-3",{
        fontSize:"15px",fill:"#FFFFFF"}
      );
      ...
      this.nivelText.setScrollFactor(0);
      this.objetivoText.setScrollFactor(0);
    }
